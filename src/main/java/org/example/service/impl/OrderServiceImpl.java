...
//        Integer customerCodeFromDB = customerRepository.findCustomerCodeByEmail(emailAccountRegistered);
...
//
    ...
    public PreviousOrdersData previousOrders(String registeredEmail) {
        log.info("this is service layer");// found error line. below is it
